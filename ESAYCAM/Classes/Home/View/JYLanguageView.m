...
- (void)changeLanguage
{
    ...
    self.englishCell.title = [[JYLanguageTool bundle] localizedStringForKey:@"English" value:nil table:@"Localizable"];
...
- (JYDirectionCell *)englishCell
{
    if (!_englishCell) {
        ...
        _englishCell = [[JYDirectionCell alloc] initWithTitle:@"English"];
