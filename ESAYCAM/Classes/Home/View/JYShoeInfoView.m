...
- (UILabel *)dzNumLabel
{
    if (!_dzNumLabel) {
        ...
        _dzNumLabel = [self createLableText:@"x1" color:[UIColor whiteColor] font:setFont(14)];
...
- (UILabel *)rateLabel
{
    if (!_rateLabel) {
        ...
        _rateLabel = [self createLableText:@"Ra:" color:[UIColor yellowColor] font:setFont(14)];
...
- (UILabel *)rateNumLabel
{
    if (!_rateNumLabel) {
        ...
        _rateNumLabel = [self createLableText:@"x1.0" color:[UIColor whiteColor] font:setFont(14)];
    }
...
- (UILabel *)lensLabel
{
    if (!_lensLabel) {
        ...
        _lensLabel = [self createLableText:@"Lens:" color:[UIColor yellowColor] font:setFont(14)];
    }
    return _lensLabel;
}
